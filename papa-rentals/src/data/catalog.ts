...
export const OWNERS: Owner[] = [
  { id: 'o1', name: 'LensCraft Studios', rating: 4.9, ratingCount: 412, verified: true, superOwner: true, responseMins: 8, area: 'DHA Phase 5', distanceKm: 2.4, memberSince: '2021' },
  { id: 'o2', name: 'Kamran Cine Hub', rating: 4.7, ratingCount: 233, verified: true, superOwner: false, responseMins: 15, area: 'Gulberg III', distanceKm: 5.1, memberSince: '2022' },
  { id: 'o3', name: 'Frame & Fable Co.', rating: 4.8, ratingCount: 187, verified: true, superOwner: true, responseMins: 5, area: 'Clifton Block 4', distanceKm: 3.8, memberSince: '2020' },
  { id: 'o4', name: 'Sara Productions', rating: 4.5, ratingCount: 96, verified: false, superOwner: false, responseMins: 32, area: 'Johar Town', distanceKm: 9.6, memberSince: '2023' },
  { id: 'o5', name: 'GripMasters PK', rating: 4.6, ratingCount: 154, verified: true, superOwner: false, responseMins: 21, area: 'Model Town', distanceKm: 7.2, memberSince: '2022' },
  { id: 'o6', name: 'Noor Haveli Estates', rating: 4.9, ratingCount: 68, verified: true, superOwner: true, responseMins: 12, area: 'Walled City', distanceKm: 11.3, memberSince: '2023' },
  { id: 'me', name: 'You', rating: 5, ratingCount: 0, verified: true, superOwner: false, responseMins: 1, area: 'Your location', distanceKm: 0, memberSince: '2026' },
  { id: 'support', name: 'Papa Support', rating: 5, ratingCount: 9999, verified: true, superOwner: false, responseMins: 1, area: 'HQ', distanceKm: 0, memberSince: '2024' },
]
...
export const ITEMS: Item[] = [
  {
    id: 'i1', name: 'ARRI Alexa Mini LF', category: 'cameras', icon: 'camera',
  ...
  {
    id: 'i2', name: 'Sony FX6 Full-Frame Kit', category: 'cameras', icon: 'video-camera',
  ...
  {
    id: 'i3', name: 'Blackmagic Pocket 6K Pro', category: 'cameras', icon: 'film',
  ...
  {
    id: 'i4', name: 'Cooke S4/i Prime Set (5 lens)', category: 'lenses', icon: 'lens',
  ...
  {
    id: 'i5', name: 'Sigma 18-35 + 50-100 Cine Zooms', category: 'lenses', icon: 'lens',
  ...
  {
    id: 'i6', name: 'Aputure 600d Pro + Light Dome II', category: 'lighting', icon: 'bulb',
  ...
  {
    id: 'i7', name: 'Astera Titan Tube Kit (8×)', category: 'lighting', icon: 'bulb',
  ...
  {
    id: 'i8', name: 'Sennheiser MKH 416 Boom Kit', category: 'audio', icon: 'mic',
  ...
  {
    id: 'i9', name: 'Sound Devices MixPre-6 II + 2× Lavs', category: 'audio', icon: 'sliders',
  ...
  {
    id: 'i10', name: 'DJI Ronin 2 + Ready Rig', category: 'grip', icon: 'video-camera',
  ...
  {
    id: 'i11', name: 'Dana Dolly + Track Package', category: 'grip', icon: 'clapperboard',
  ...
  {
    id: 'i12', name: 'DJI Inspire 3 + Licensed Pilot', category: 'drones', icon: 'drone',
  ...
  {
    id: 'i13', name: 'DJI Mavic 3 Cine', category: 'drones', icon: 'drone',
  ...
  {
    id: 'i14', name: '15-Seater Crew Van + Driver', category: 'transport', icon: 'van',
  ...
  {
    id: 'i15', name: '5-Ton Grip Truck (Loaded)', category: 'transport', icon: 'truck',
  ...
  {
    id: 'i16', name: 'Picture Car: 1967 Mustang', category: 'transport', icon: 'car',
  ...
  {
    id: 'i17', name: 'Daylight Studio A (2000 sqft)', category: 'studios', icon: 'building',
  ...
  {
    id: 'i18', name: 'Greenscreen Stage B + Grid', category: 'studios', icon: 'greenscreen',
  ...
  {
    id: 'i19', name: 'Period Furniture Set (1940s)', category: 'props', icon: 'armchair',
  ...
  {
    id: 'i20', name: 'Director’s Village Kit', category: 'crew', icon: 'wrench',
  ...
  {
    id: 'i21', name: 'Skyline Rooftop Terrace', category: 'studios', icon: 'skyline',
  ...
  {
    id: 'i22', name: 'Noor Haveli (Heritage Home)', category: 'studios', icon: 'landmark',
  ...
  {
    id: 'i23', name: 'Raw Warehouse Shell (12k sqft)', category: 'studios', icon: 'warehouse',
  ...
  {
    id: 'i24', name: 'Designer Penthouse Apartment', category: 'studios', icon: 'sofa',
...
export const TRANSPORT_OPTIONS: TransportOption[] = [
  { id: 'pickup', name: 'Self pickup', icon: 'hand', fee: 0, eta: 'You collect', detail: 'Pick up from the owner’s location at your chosen time. Bring CNIC.' },
  { id: 'van', name: 'Papa Van delivery', icon: 'van', fee: 2500, eta: '60–90 min', detail: 'Insured van delivery to your set, live-tracked like your food order.' },
  { id: 'truck', name: 'Grip truck + crew', icon: 'truck', fee: 9000, eta: 'Scheduled', detail: 'Truck with a 2-person crew who load, deliver and help you rig.' },
]
...
export const PAYMENT_METHODS: { id: string; name: string; icon: import('../components/icons').IconName }[] = [
  { id: 'card', name: 'Debit / credit card', icon: 'card' },
  { id: 'jazzcash', name: 'JazzCash', icon: 'mobile' },
  { id: 'easypaisa', name: 'Easypaisa', icon: 'mobile' },
...
export const SPACE_TYPES: { type: string; icon: import('../components/icons').IconName }[] = [
  { type: 'Studio', icon: 'building' },
  { type: 'Greenscreen stage', icon: 'greenscreen' },
  { type: 'Rooftop', icon: 'skyline' },
  { type: 'Heritage home', icon: 'landmark' },
  { type: 'Warehouse', icon: 'warehouse' },
  { type: 'Apartment', icon: 'sofa' },
  { type: 'Café / restaurant', icon: 'coffee' },
  { type: 'Farmhouse / outdoor', icon: 'tree' },
]
